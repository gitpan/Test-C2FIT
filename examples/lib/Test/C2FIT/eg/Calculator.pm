...
{
	my $pkg = shift;
    my $types = {   x => 'Test::C2FIT::ScientificDoubleTypeAdapter',
                    y => 'Test::C2FIT::ScientificDoubleTypeAdapter',
                    z => 'Test::C2FIT::ScientificDoubleTypeAdapter',
                    t => 'Test::C2FIT::ScientificDoubleTypeAdapter',
    };
	return bless $pkg->SUPER::new(volts => 0.0 , key => undef, methodColumnTypeMap => $types ), $pkg;
}
...
sub x() {
    return Test::C2FIT::ScientificDouble->new($Test::C2FIT::eg::Calculator::HP35::r[0]);
}

sub y() {
    return Test::C2FIT::ScientificDouble->new($Test::C2FIT::eg::Calculator::HP35::r[1]);
}

sub z() {
    return Test::C2FIT::ScientificDouble->new($Test::C2FIT::eg::Calculator::HP35::r[2]);
}

sub t() {
    return Test::C2FIT::ScientificDouble->new($Test::C2FIT::eg::Calculator::HP35::r[3]);
}
